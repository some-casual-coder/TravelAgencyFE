...
const routes: Routes = [
  ...
  {path:'admin/hotels', component:HotelsComponent, canActivate:[AuthGuard], data:{roles:['ROLE_HOST','ROLE_ADMIN','ROLE_SUPER_ADMIN']}},
  {path:'admin/rooms/:hotelId', component:ViewHotelRoomsComponent, canActivate:[AuthGuard], data:{roles:['ROLE_ADMIN','ROLE_SUPER_ADMIN']}},
  {path:'admin/transportTypes', component:TransportTypeComponent, canActivate:[AuthGuard], data:{roles:['ROLE_ADMIN','ROLE_SUPER_ADMIN']}},
  {path:'admin/transport', component:MeansOfTransportComponent, canActivate:[AuthGuard], data:{roles:['ROLE_HOST','ROLE_ADMIN','ROLE_SUPER_ADMIN']}},
